...
<!-- 
					...
					<!-- 
			        	...
			        	$queryy = mysqli_query($conn, "SELECT * FROM `videos`") or die(mysqli_error());
					...
					<?php 
						$fetch2 = mysqli_fetch_array($queryy);
					  	echo
							"<div class='pd-20 card-box mb-30' style='width:300px;'>
								...
								<div class='container'>
									<video poster='{$fetch2['video_img']}' src='{$fetch2['video']}'></video>
								</div>
							</div>"
					?>
					<?php
						     ...
						     while($fetch =mysqli_fetch_array($query) )
						          {
						             ?>
						                  <div class="pd-20 card-box mb-30 " style="width:390px;">
											  <div class='clearfix mb-20'style='width:390px;'>
												  	<div class='pull-left'>
												...
												<div class='container'style='width:300px;'>
													<video width='300' height='250' poster='<?php echo $fetch['video_img']?>' src=<?php echo $fetch['video']?>></video>
												</div>
						                  		</div>
								  			</div>
						              <?php
